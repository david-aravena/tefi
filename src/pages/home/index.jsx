    ...
    <>
      <div style={{ width: width, backgroundColor:"#f4f3f5" }}>
        ...
        <div className="containerComponents">
          <div className="containerListCards">
            <div style={{padding:"8px 1rem"}}>
              <h3 style={{fontSize:"1.5rem", color:"var(--black-tefi)"}}>Componentes</h3>
              <p style={{color:"var(--black-tefi)", margin:0, padding:"1rem 0"}}> 
                <span style={{ fontWeight: "bold" }}>¿Qué ofrecemos?:</span> Diseñamos y desarrollamos componentes a medida para tu sitio web o aplicación.
            ...
            <div style={{width:"100%", display:"flex",  overflow: "auto", padding:"8px 0"}}>
        ...
        <div className="containerComponents">
          <div className="containerListCards">
            <div style={{padding:"8px 1rem"}}>
              <h3 style={{fontSize:"1.5rem", color:"var(--black-tefi)"}}>Logos animados</h3>
              <p style={{color:"var(--black-tefi)", margin:0, padding:"1rem 0"}}> 
